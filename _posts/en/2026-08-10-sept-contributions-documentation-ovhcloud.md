...
This first cycle has been accepted, and the follow-up has already landed: eight more contributions were accepted in August (EOL images, anchors, `mdstat` markers), others are under review — the detailed summary, and above all what the maintainer's reviews taught me, are covered in the next post: ["When a maintainer becomes a mentor: lessons from the OVHcloud reviews"](/posts/en/lecons-des-revues-mainteneur-ovhcloud/). The question is therefore no longer "how many PRs can I open?" but **"which improvement can I prove without asking the maintainer to take my word for it?"**
