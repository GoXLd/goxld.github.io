...
Ce premier cycle est accepté, et la suite est déjà arrivée : huit nouvelles contributions ont été acceptées en août (images EOL, ancres, marqueurs `mdstat`), d'autres sont en revue — le bilan détaillé, et surtout ce que les revues du mainteneur m'ont appris, font l'objet du billet suivant : [« Quand un mainteneur devient mentor : les leçons des revues OVHcloud »](/posts/lecons-des-revues-mainteneur-ovhcloud/). La question n'est donc plus « combien de PR puis-je ouvrir ? », mais **« quelle amélioration puis-je prouver sans demander au mainteneur de me croire sur parole ? »**
